    ...
    <div className="flex items-center justify-center">
            <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10`}>
                <div className="mb-2 flex justify-center">
                    ...
                    <form onSubmit={handleSubmit(signup,(errors)=>{
                      console.log(errors);
                    })}>
                        ...
                        {errors.name && <p className='text-red-600 mt-8 text-center'>{errors.name.message}</p>}
                            ...
                            <Button children={"Create Account"} type='submit' classname='inline-bock px-6 py-2 duration-200 hover:bg-blue-500 rounded-full w-full'/>
